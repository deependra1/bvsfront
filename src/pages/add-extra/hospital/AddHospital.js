...
export default function AddHospital() {
  ...
  const handleEdit = (hospital) => {
    setSelectedHospital(hospital.row);
    setOpen(true);
  };
  ...
  const handleAddHospital = (values, { setErrors, setStatus, setSubmitting }) => {
    if (selectedHospital.id) {
      axiosService
        .put(`/hospital/${selectedHospital.id}/`, values)
        .then(() => {
    ...
    <div>
      ...
      <BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
        <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
          {selectedHospital.id ? 'Update hospital' : 'Add hospital'}
            ...
            <Form noValidate>
                  ...
                  <Grid item xs={12}>
                    <Stack spacing={1}>
                      ...
                      <OutlinedInput
                        ...
                        error={Boolean(touched.hospital_name && errors.hospital_name)}
                      />
                      {touched.hospital_name && errors.hospital_name && (
                        <FormHelperText error id="standard-weight-helper-text-hospital_name">
              ...
              <DialogActions>
                <Button autoFocus variant="outlined" disableElevation disabled={isSubmitting} onClick={handleSubmit} color="primary">
                  {selectedHospital.id ? 'Update' : 'Save'}
                </Button>
