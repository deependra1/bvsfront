...
import AddPatientPhychosocial from './AddPatientPhychosocial';

const PatientPhychosocialDetail = () => {
  ...
  return (
    <MainCard title="Patients Phychosocial Detail">
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={12}>
          <Divider>
            <Chip label="PHYCHOSOCIAL" color="primary" />
          </Divider>
        </Grid>
        <Grid item xs={12} md={12}>
          <AddPatientPhychosocial />
        </Grid>
      </Grid>
    </MainCard>
  );
...
export default PatientPhychosocialDetail;
