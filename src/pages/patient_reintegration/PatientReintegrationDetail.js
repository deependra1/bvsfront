...
import AddPatientReintegration from './AddPatientReintegration';

const PatientReintegrationDetail = () => {
  ...
  return (
    <MainCard title="Patients Reintegration Detail">
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={12}>
          <Divider>
            <Chip label="Reintegration" color="primary" />
          </Divider>
        </Grid>
        <Grid item xs={12} md={12}>
          <AddPatientReintegration />
        </Grid>
      </Grid>
    </MainCard>
  );
...
export default PatientReintegrationDetail;
