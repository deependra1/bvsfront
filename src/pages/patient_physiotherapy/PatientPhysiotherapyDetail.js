...
import AddPatientPhysiotherapy from './AddPatientPhysiotherapy';

const PatientPhysiotherapyDetail = () => {
  ...
  return (
    <MainCard title="Patients Physiotherapy Detail">
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={12}>
          <Divider>
            <Chip label="PHYSIOTHERAPY" color="primary" />
          </Divider>
        </Grid>
        <Grid item xs={12} md={12}>
          <AddPatientPhysiotherapy />
        </Grid>
      </Grid>
    </MainCard>
  );
...
export default PatientPhysiotherapyDetail;
